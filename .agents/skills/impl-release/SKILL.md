---
name: impl-release
description: katana-language-editor で指定バージョンの実装、品質確認、release branch PR 作成、cloud review 依頼、自動リリース確認までを一気通貫で進めるときに使う。/impl-release vX.Y.Z と同等のリリース実装ワークフロー。
---

# impl-release

`/impl-release vX.Y.Z` として扱う、katana-language-editor のリリース実装入口です。
