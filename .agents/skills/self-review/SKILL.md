---
name: self-review
description: katana-language-editor の差分をコミットや PR 前に自己レビューする。設計、テスト、品質ゲート、公開 API、language editor 境界を確認するときに使う。
---
...
- language editor と egui implementation の失敗経路
